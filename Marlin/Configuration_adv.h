 ...
 */
#define DEFAULT_STEPPER_TIMEOUT_SEC 3600  // 120
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define BINARY_FILE_TRANSFER // ***** Off by default

  #if ENABLED(BINARY_FILE_TRANSFER)
    // Include extra facilities (e.g., 'M20 F') supporting firmware upload via BINARY_FILE_TRANSFER
    #define CUSTOM_FIRMWARE_UPLOAD // ***** Off by default
  #endif
 ...
 */
#define ADVANCED_PAUSE_FEATURE // ***** Off by default
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      150  // (mm) The length of filament for a complete unload. // ***** Default 100
  ...
  #define PARK_HEAD_ON_PAUSE                    // Park the nozzle during pause and filament change. // ***** Off by default
 ...
 */
#define HOST_ACTION_COMMANDS // ***** Off by default
