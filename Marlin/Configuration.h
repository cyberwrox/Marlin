...
//Diag jumpers for sensorless homing confirm removed (disables compiler warning)
...
#define CUSTOM_MACHINE_NAME "Ender-5 Pro E3 SKR mini V3.0"
//#define CUSTOM_MACHINE_NAME "Test"
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_KP  31.51
    #define DEFAULT_KI   4.58
    #define DEFAULT_KD  54.20
  #endif
#else
...
#define PIDTEMPBED
  ...
  #define DEFAULT_BED_KP   177.14
  #define DEFAULT_BED_KI   32.56
  #define DEFAULT_BED_KD   642.42
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, -35, -0.825 }
